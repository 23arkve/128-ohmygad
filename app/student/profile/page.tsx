...
import { User, Phone, BookOpen, MapPin, Save } from "lucide-react";
				...
				<div className="w-full lg:w-[35%] lg:min-w-[240px] shrink-0 flex flex-col">
					...
					>
						...
						<div className="flex flex-wrap justify-center gap-2 mb-4">
							<Badge variant="periwinkle">Student</Badge>
							{displayed.student_num && (
								<Badge variant="pink-light">
									#{displayed.student_num}
								</Badge>
							)}
							{displayed.year_level && (
								<Badge variant="pink-light">
									{displayed.year_level}
								</Badge>
							)}
						...
						<div className="w-full text-left pt-3 border-t border-[rgba(45,42,74,0.08)]">
							<ProgressBar
								value={Math.min(
									((displayed.gso_attended ?? 0) / 2) * 100,
									100,
								)}
								variant="gradient"
						...
						<div className="w-full text-left pt-3 border-t border-[rgba(45,42,74,0.08)]">
							<ProgressBar
								value={Math.min(
									((displayed.asho_attended ?? 0) / 2) * 100,
									100,
								)}
								variant="gradient"
						...
						<div className="w-full text-left pt-3 border-t border-[rgba(45,42,74,0.08)]">
							<ProgressBar
								value={Math.min(
									((displayed.forum_attended ?? 0) / 2) * 100,
									100,
								)}
								variant="periwinkle"
						...
						<div className="w-full text-left pt-3 border-t border-[rgba(45,42,74,0.08)]">
							<ProgressBar
								value={Math.min(
									((displayed.research_attended ?? 0) / 2) *
										100,
									100,
								)}
								variant="periwinkle"
						...
						<div className="w-full text-left pt-3 border-t border-[rgba(45,42,74,0.08)]">
							<ProgressBar
								value={Math.min(
									((displayed.training_attended ?? 0) / 2) *
										100,
									100,
								)}
								variant="periwinkle"
						...
						<div className="w-full text-left pt-3 border-t border-[rgba(45,42,74,0.08)]">
							<ProgressBar
								value={Math.min(
									((displayed.workshop_attended ?? 0) / 2) *
										100,
									100,
								)}
								variant="periwinkle"
