...
\begin{itemize}[leftmargin=1.5em]
  ...
  \item \textbf{Non-binary, Transgender woman, Transgender man} — Non-binary gender identities.
...
A donut chart showing the distribution of users by gender identity (Man, Woman, Non-binary, Transgender woman, Transgender man, Prefer not to say). This data supports the university's commitment to inclusive gender representation. Hovering over a segment displays the exact count for that category.
...
\begin{fieldtable}
  ...
  \fieldrow{Gender Identity *}{Yes}{Dropdown}{Options: Man, Woman, Non-binary, Transgender woman, Transgender man, or Prefer not to say. Required to capture user's gender identity.}
\end{fieldtable}
