				...
				<>
					...
					>
						...
						<div className="flex h-[100px] shrink-0 items-center justify-between border-b border-white/[0.07] px-4">
							<Link href="/faculty" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
								<Image
...
export default function FacultySidebar() {
	...
	return (
		...
		>
			...
			>
				{/* logo */}
				<Link href="/faculty" className="flex shrink-0 items-center pb-4 py-5 overflow-hidden hover:opacity-80 transition-opacity">
					<div
