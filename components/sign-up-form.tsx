...
export function SignUpForm({
	...
	return (
		<div
			className={cn("auth-card max-w-md w-full mx-auto", className)}
			{...props}
		>
			...
			{/* <form onSubmit={handleSignUp} className="flex flex-col gap-3">
				...
				<Button
					type="submit"
					disabled={
						!email || !password || !repeatPassword || isLoading
					}
					variant="primary"
					className="mt-2"
				>
			...
			<form
				...
				className="flex flex-col gap-4 pt-2 items-center"
			>
				{eventId && (
